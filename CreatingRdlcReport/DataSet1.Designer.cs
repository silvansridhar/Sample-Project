...
namespace CreatingRdlcReport {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UserInfoDataTable : global::System.Data.TypedTableBase<UserInfoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UserInfoRow AddUserInfoRow(int UserId, string UserName, string UserLName, System.DateTime DOB, byte Age, string Gender, string Address, bool IsDeleted) {
        ...
        public partial class UserInfoRow : global::System.Data.DataRow {
            ...
            public string UserLName {
                get {
                    return ((string)(this[this.tableUserInfo.UserLNameColumn]));
                }
                set {
                    this[this.tableUserInfo.UserLNameColumn] = value;
                }
            }
            ...
            public byte Age {
                get {
                    return ((byte)(this[this.tableUserInfo.AgeColumn]));
                }
                set {
            ...
            public bool IsDeleted {
                get {
                    return ((bool)(this[this.tableUserInfo.IsDeletedColumn]));
                }
                set {
...
namespace CreatingRdlcReport.DataSet1TableAdapters {
    ...
    public partial class UserInfoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[UserInfo] WHERE (([UserId] = @Original_UserId) AND ([UserName] = @Original_UserName) AND ([UserLName] = @Original_UserLName) AND ([DOB] = @Original_DOB) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([Address] = @Original_Address) AND ([IsDeleted] = @Original_IsDeleted))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[UserInfo] ([UserId], [UserName], [UserLName], [DOB], [Age], [Gender], [Address], [IsDeleted]) VALUES (@UserId, @UserName, @UserLName, @DOB, @Age, @Gender, @Address, @IsDeleted);
SELECT UserId, UserName, UserLName, DOB, Age, Gender, Address, IsDeleted FROM UserInfo WHERE (UserId = @UserId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[UserInfo] SET [UserId] = @UserId, [UserName] = @UserName, [UserLName] = @UserLName, [DOB] = @DOB, [Age] = @Age, [Gender] = @Gender, [Address] = @Address, [IsDeleted] = @IsDeleted WHERE (([UserId] = @Original_UserId) AND ([UserName] = @Original_UserName) AND ([UserLName] = @Original_UserLName) AND ([DOB] = @Original_DOB) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([Address] = @Original_Address) AND ([IsDeleted] = @Original_IsDeleted));
SELECT UserId, UserName, UserLName, DOB, Age, Gender, Address, IsDeleted FROM UserInfo WHERE (UserId = @UserId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CreatingRdlcReport.Properties.Settings.Default.RdlcReportConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, UserName, UserLName, DOB, Age, Gender, Address, IsDeleted FROM dbo" +
                ".UserInfo";
        ...
        public virtual int Delete(int Original_UserId, string Original_UserName, string Original_UserLName, System.DateTime Original_DOB, byte Original_Age, string Original_Gender, string Original_Address, bool Original_IsDeleted) {
        ...
        public virtual int Insert(int UserId, string UserName, string UserLName, System.DateTime DOB, byte Age, string Gender, string Address, bool IsDeleted) {
        ...
        public virtual int Update(
            ...
            if ((Original_UserLName == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_UserLName));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string UserName, string UserLName, System.DateTime DOB, byte Age, string Gender, string Address, bool IsDeleted, int Original_UserId, string Original_UserName, string Original_UserLName, System.DateTime Original_DOB, byte Original_Age, string Original_Gender, string Original_Address, bool Original_IsDeleted) {
            return this.Update(Original_UserId, UserName, UserLName, DOB, Age, Gender, Address, IsDeleted, Original_UserId, Original_UserName, Original_UserLName, Original_DOB, Original_Age, Original_Gender, Original_Address, Original_IsDeleted);
        }
    }
